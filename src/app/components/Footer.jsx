...
export default function Footer() {
    return (
        <footer className='pl-8 md:pl-16 2xl:pl-48 py-10 bg-[#E7C285] text-black'>

            <div className='flex flex-col md:flex-row items-start justify-between'>
                <Image src={'/images/dark-logo.svg'} width={150} height={150} alt={''} className=' md:mb-0 md:mr-40'/>
                <div className='flex-1 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1'>{footerData.map((section, index) => {
                    return (
                        <div key={index}>
                            <h4 className='font-bold text-xl md:my-0 md:mb-4 my-5'>{section.title}</h4>
